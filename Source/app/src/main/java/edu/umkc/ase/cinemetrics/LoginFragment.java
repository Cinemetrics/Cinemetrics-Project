...
import edu.umkc.ase.cinemetrics.constants.AppConstants;
import edu.umkc.ase.cinemetrics.helpers.FbConnectHelper;
import edu.umkc.ase.cinemetrics.helpers.GooglePlusSignInHelper;
import edu.umkc.ase.cinemetrics.helpers.TwitterConnectHelper;
...
public class LoginFragment extends Fragment implements TwitterConnectHelper.OnTwitterSignInListener, FbConnectHelper.OnFbSignInListener, GooglePlusSignInHelper.OnGoogleSignInListener{
    ...
    @OnClick(R.id.login_getstarted)
    public void getStarted(View view) {
        Intent redirect=new Intent(getActivity(),SearchActivity.class);
